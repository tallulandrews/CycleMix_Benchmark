...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Wang_colon_purity50.rds")
...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Wang_ileum_purity50.rds")
...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Moreno_glioblastoma_purity50_SUBSAMPLE.rds")
...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Gu_lymph_purity50.rds")
...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Triana_bonemarrow_purity50.rds")
...
saveRDS(list(seur_g2m_purity50=seur_g2m_purity50,seur_S_purity50=seur_S_purity50, cyc_g2m_purity50=cyc_g2m_purity50, cyc_S_purity50=cyc_S_purity50, lone_g2m_purity50=lone_g2m_purity50, lone_S_purity50=lone_S_purity50), file="Streets_adipose_purity50.rds")
...
files <- Sys.glob("*_purity50.rds")
out <- c()
for (f in files) {
	samp_name <- unlist(strsplit(f, "_"))
	samp_name <- paste(samp_name[1], samp_name[2], sep="_")
	stuff <- readRDS(f)
	seur <- cbind(c("Seurat", "Seurat"),c("G1S", "G2M"), c(median(stuff$seur_S_purity50), median(stuff$seur_g2m_purity50)), c(samp_name, samp_name))
	cyc <- cbind(c("CycleMix", "CycleMix"), c("G1S", "G2M"), c(median(stuff$cyc_S_purity50), median(stuff$cyc_g2m_purity50)), c(samp_name, samp_name))
	lone <- cbind(c("Cyclone", "Cyclone"),c("G1S", "G2M"), c(median(stuff$lone_S_purity50), median(stuff$lone_g2m_purity50)), c(samp_name, samp_name))
	out <- rbind(out, seur, cyc, lone)
	seur_test = wilcox.test(stuff$seur_g2m_purity50, stuff$seur_S_purity50)
	cyc_test = wilcox.test(stuff$cyc_g2m_purity50, stuff$cyc_S_purity50)
	lone_test = wilcox.test(stuff$lone_g2m_purity50, stuff$lone_S_purity50)
...
png("Real_Datasets_purity50.png", width=8*0.65, height=6*0.65, units="in", res=300)
print(p)
dev.off()
